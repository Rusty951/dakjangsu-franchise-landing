...
const privacyPolicySections = [
  ...
  {
    title: '6. Meta Pixel 및 쿠키 안내',
    items: [
      '이 사이트는 방문 및 상담 행동 측정을 위해 Meta Pixel을 사용하며, Meta 등 제3자가 쿠키·웹 비콘·유사 저장 기술을 통해 정보를 수집하거나 받을 수 있습니다.',
      '수집된 정보는 측정 서비스, 광고 전달 및 성과 분석에 이용될 수 있습니다. 이용자는 브라우저 쿠키 설정과 Meta 광고 설정에서 관련 선택을 관리할 수 있습니다.'
    ]
  },
  {
    title: '7. 정보주체의 권리',
